...
def union_parent(parent, node1, node2):
    ...
    :param node2: 노드2
    """""
    root_node1 = find_root(parent, node1)
    root_node2 = find_root(parent, node2)
...
for a, b in union_data:
    union_parent(root_list, a, b)

# 루트 테이블
print(root_list)  # [0, 1, 1, 2, 1, 5, 5]

# 루트 노드 반환
for i in range(1, vertex_num + 1):
    print("노드 번호:{} 루트 노드:{}".format(i, find_root(root_list, i)))
